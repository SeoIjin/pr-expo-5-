...
$sql_user = "SELECT email, name, age, contact, usertype FROM useraccount WHERE id = '$user_id'";
...
// Optionally, you can fetch additional data from the database if needed
            ...
            <h1>User Profile</h1>
              <!-- Profile Picture (optional) -->
               <label for="profile-pic" class="profile-pic-label">
                ...
                <input type="file" id="profile-pic" class="profile-pic-input" accept="image/*" style="display: none;" onchange="previewImage(event)">
